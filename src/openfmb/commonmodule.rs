...
pub struct DeviceControl {
    ...
    #[prost(message, optional, tag="2")]
    pub ansi79lo: ::std::option::Option<ControlSpc>,
    /// Fault latch: LT01=51A OR 51B OR 51C
    #[prost(message, optional, tag="3")]
    pub fault_latch: ::std::option::Option<ControlSpc>,
    /// True if hot line tag added
    #[prost(message, optional, tag="4")]
    pub hot_line_tag: ::std::option::Option<ControlSpc>,
    /// True if there is an IED trouble.
    #[prost(message, optional, tag="5")]
    pub ied_trouble: ::std::option::Option<ControlSpc>,
    /// Reclose enabled
...
pub struct DeviceStatus {
    ...
    /// ANSI 79 - AC Reclosing Relay / Auto Reclose
    #[prost(message, optional, tag="2")]
    pub ansi79lo: ::std::option::Option<StatusSps>,
    /// Fault latch: LT01=51A OR 51B OR 51C
    #[prost(message, optional, tag="3")]
    pub fault_latch: ::std::option::Option<StatusSps>,
    /// True if hot line tag added
    #[prost(message, optional, tag="4")]
    pub hot_line_tag: ::std::option::Option<StatusSps>,
    /// True if there is an IED trouble.
    #[prost(message, optional, tag="5")]
    pub ied_trouble: ::std::option::Option<StatusSps>,
    /// Reclose enabled
    #[prost(message, optional, tag="6")]
    pub reclose_enabled: ::std::option::Option<StatusSps>,
    /// Remote enabled
